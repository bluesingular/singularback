...
import { tapClientLookup, attachTransformScopes, tapClientResource, Derived, } from "@assistant-ui/store";
...
const ComposerClientResource = resource(({ type, isEditing, canCancel, onCancel, onBeginEdit, onSend, message, queue, }) => {
...
export const ExternalThread = resource(({ messages, isRunning = false, onNew, onEdit, onReload, onStartRun, onCancel, queue, }) => {
