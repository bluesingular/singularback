import { ThreadSuggestion, RuntimeCapabilities, ThreadRuntimeCore, SpeechState, VoiceSessionState, ThreadRuntimeEventType, StartRunConfig, ResumeRunConfig } from "../interfaces/thread-runtime-core.js";
    ...
    get __internal_threadBinding(): import("../../internal").Subscribable & {
        ...
        getState: () => Readonly<{
            ...
            composer: Readonly<{
                ...
                stopDictation: () => void;
                subscribe: (callback: () => void) => Unsubscribe;
                unstable_on: (event: import("../..").ComposerRuntimeEventType, callback: () => void) => Unsubscribe;
            }>;
