...
import type { RemoteThreadData, THREAD_MAPPING_ID } from "../../runtimes/remote-thread-list/remote-thread-state.js";
...
export declare class RemoteThreadListThreadListRuntimeCore extends BaseSubscribable implements ThreadListRuntimeCore {
    ...
    getMainThreadRuntimeCore(): Readonly<{
        ...
        startRun: (config: import("../..").StartRunConfig) => void;
        resumeRun: (config: import("../..").ResumeRunConfig) => void;
        cancelRun: () => void;
        ...
        composer: import("../..").ThreadComposerRuntimeCore;
        getEditComposer: (messageId: string) => import("../..").EditComposerRuntimeCore | undefined;
        beginEdit: (messageId: string) => void;
        speech: import("../..").SpeechState | undefined;
        voice: import("../..").VoiceSessionState | undefined;
        capabilities: Readonly<import("../..").RuntimeCapabilities>;
        isDisabled: boolean;
        isLoading: boolean;
        ...
        subscribeVoiceVolume: (callback: () => void) => import("../..").Unsubscribe;
        ...
        unstable_on(event: import("../..").ThreadRuntimeEventType, callback: () => void): import("../..").Unsubscribe;
    ...
    initialize: (threadId: string) => Promise<import("../..").RemoteThreadInitializeResponse>;
