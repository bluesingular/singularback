...
importers:
  ...
  server:
    dependencies:
      ...
      stripe:
        specifier: ^22.1.1
        version: 22.1.1(@types/node@24.12.0)
      web-push:
        specifier: ^3.6.7
        version: 3.6.7
      ws:
  ...
  ui:
    dependencies:
      ...
      react-i18next:
        specifier: ^17.0.4
        version: 17.0.4(i18next@26.0.7(typescript@5.9.3))(react-dom@19.2.4(react@19.2.4))(react@19.2.4)(typescript@5.9.3)
      react-markdown:
        specifier: ^10.1.0
...
packages:
  ...
  '@mendable/firecrawl-js@4.18.3':
    resolution: {integrity: sha512-he/aFwWKjNwrHO5SPNxhs1Z0KBUbSjDnCt3nRnmxw1Osd2F/yjJZ6BYSnp8ub4A64isH1GaN0Fehsjt3u5sKTQ==}
    engines: {node: '>=22.0.0'}
