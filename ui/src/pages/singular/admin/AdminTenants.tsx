...
import { adminApi, type TenantSummary } from "@/api/admin"
import { Users, Bot, CheckSquare, Euro, ExternalLink, Eye } from "lucide-react"
            ...
            <div key={t.id} className="p-4 flex items-center gap-4 hover:bg-[#FAFAF8] transition-colors">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center gap-3 flex-wrap">
                  ...
                  <Metric icon={CheckSquare} value={t.tasksLast30d} label="tasks/30d" />
