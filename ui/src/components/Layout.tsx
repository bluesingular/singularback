...
export function Layout() {
  ...
  const isSingularRoute = /\/(dashboard|team|trust|tasks|console|reports|contacts|settings|voice|documents|financial-pulse|ceo-health|meeting-briefing|performances|missions|catalogue|installation|approbations|approvals|away|partenaires)(\/|$)/.test(location.pathname);
