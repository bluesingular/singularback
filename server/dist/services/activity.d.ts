...
export declare function activityService(db: Db): {
    ...
    runsForIssue: (companyId: string, issueId: string) => Omit<import("drizzle-orm/pg-core").PgSelectBase<"heartbeat_runs", {
        ...
        usageJson: import("drizzle-orm").SQL.Aliased<Record<string, unknown> | null>;
        resultJson: import("drizzle-orm").SQL.Aliased<Record<string, unknown> | null>;
    ...
    }, "partial", Record<"heartbeat_runs", "not-null"> & {
        agents: "not-null";
    }, false, "where" | "orderBy", {
        runId: string;
        status: string;
