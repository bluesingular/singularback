import { pgTable, uuid, text, timestamp, jsonb, boolean, customType, uniqueIndex, index, } from "drizzle-orm/pg-core";
...
export const agentIntegrationPermissions = pgTable("agent_integration_permissions", {
    id: uuid("id").primaryKey().defaultRandom(),
...
export const webhookEndpoints = pgTable("webhook_endpoints", {
    ...
    routingRules: jsonb("routing_rules").$type().notNull().default([]),
