export declare const companies: import("drizzle-orm/pg-core").PgTableWithColumns<{
    ...
    columns: {
        ...
        tasksUsedMonth: import("drizzle-orm/pg-core").PgColumn<{
            name: "tasks_used_month";
            tableName: "companies";
            dataType: "number";
            columnType: "PgInteger";
            data: number;
        ...
        tasksLimitMonth: import("drizzle-orm/pg-core").PgColumn<{
            name: "tasks_limit_month";
            tableName: "companies";
            dataType: "number";
            columnType: "PgInteger";
            data: number;
        ...
        tokensLimitMonth: import("drizzle-orm/pg-core").PgColumn<{
            name: "tokens_limit_month";
            tableName: "companies";
            dataType: "number";
            columnType: "PgBigInt53";
            data: number;
